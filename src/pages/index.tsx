  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-screen-xl min-h-screen px-4 sm:px-6 pt-[6rem] lg:px-8">
        <div className='text-4xl font-semibold py-5'>All Items</div>

        <div className="grid grid-cols-2 pb-[10rem] sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {listings?.map((product: Inputs) => (
            <Link key={product.id} href={`/${product?.id}`} className="flex flex-col border rounded-lg overflow-hidden shadow-lg hover:shadow-xl transform transition duration-200 hover:scale-105">
              ...
              <div className="px-4 py-2 flex-grow">
                <h2 className="text-md lg:text-lg font-medium mb-2 capitalize">{product.name}</h2>
                <div className="flex gap-2">

                  <p className="text-gray-500 text-sm lg:text-md font-medium mb-2 ">₹{product.price}</p>
